...
def main():
    ...
    findings={
      ...
      "no_unsupported_trade_score_reweight_in_first_pass":(backlog.get("improve_now_with_existing_evidence") or [])[2].get("status")=="ABLATION_ACTIVE_NO_SAFE_REWEIGHT_YET",
    }
    payload={
      ...
      "policy":{
        ...
        "no_new_coefficients_without_incremental_evidence":True,
