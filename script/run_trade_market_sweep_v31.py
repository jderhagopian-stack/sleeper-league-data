...
def main():
    ...
    report.setdefault("governance", {})["option_outcome_consistency"] = {
        ...
        "post_sim_score_is_shared_decision_utility_compatibility_alias": True,
        "better_worse_uses_single_authoritative_shared_decision_utility": True,
        "decision_outputs": list(gov.DECISION_OUTPUTS),
        "frontier_diagnostic_outputs": list(gov.FRONTIER_DIAGNOSTIC_OUTPUTS),
    ...
    report.setdefault("policy", {}).update({
        ...
        "option_comparison_uses_authoritative_shared_decision_utility": True,
        "option_comparison_uses_pareto_decision_outputs": False,
        "simulator_frontier_metrics_are_diagnostic_only_after_shared_utility_composition": True,
        ...
        "better_requires_higher_shared_decision_utility": True,
        "worse_requires_lower_shared_decision_utility": True,
        "raw_metric_tradeoffs_are_reported_not_recounted": True,
