...
def first_release_contracts() -> tuple[ViewContract, ...]:
    contracts = (
        ...
        ViewContract(
            ...
            upstream_authorities=("Projection System", "Canonical valuation sources", "Simulator"),
            governed_fields=(
                "team_id",
                "position",
                ...
                "future_draft_capital_market_value",
                "simulator_competitive_outcomes",
            ),
            presentation_transforms=("league_rank", "league_percentile"),
            allowed_operations=(
                "filter",
                "group",
                "sort_single_governed_field",
        ...
        ViewContract(
            ...
            upstream_authorities=("Canonical valuation sources", "GM3 Team Improvement", "Simulator"),
            governed_fields=(
                "asset_id",
                "owner_team_id",
                "market_value",
                "gm3_viewer_gross_marginal_utility",
                "gm3_current_owner_zero_compensation_utility",
                "gm3_utility_components",
                "simulator_outcome_delta",
                "positional_market_value_percentile",
            ),
            presentation_transforms=("league_relative_strength_gap",),
            allowed_operations=(
                "filter",
                "group",
                "sort_single_governed_field",
