...
def main():
    ...
    findings={
      ...
      "fixed_trade_utility_conversion_constants_removed":"FSFFL-Shared-Decision-Utility-2.2" in utility and all(x not in utility for x in ("CURRENT_TITLE_SCALE","CURRENT_PLAYOFF_SCALE","CURRENT_WINS_SCALE","CURRENT_POINTS_SCALE","FUTURE_OPTIONALITY_SCALE","LIQUIDITY_SCALE","RESILIENCE_SCALE","OPPONENT_EXTERNALITY_SCALE")) and '"fixed_unit_conversion_coefficients_used": False' in utility,
