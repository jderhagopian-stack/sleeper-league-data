...
def apply_report_metadata(report, inherited_action, state_policy):
    report.setdefault("policy", {}).update({
        ...
        "acceptance_band_is_ranking_signal_not_eligibility_gate": False,
        "acceptance_fit_used_as_negotiation_ranking_signal": False,
        "negotiation_ranking_uses_canonical_focal_utility": True,
