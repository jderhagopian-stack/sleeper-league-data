...
INTENTIONAL_MECHANICAL_PINS = {
    ("script/run_trade_market_sweep_v31.py", "script/run_trade_market_sweep_v26.py"):
        "Current v31 consumes the retained v26 simulated candidate frontier, then applies version-neutral candidate-pool, roster-resolution, roster-interaction, and option-governance components. Historical v27-v30 wrappers are bypassed.",
}
