...
def build_board(source,a,reviews):
    ...
    b['search_configuration']={'trade_candidates':a.trade_screen,'waiver_candidates':a.waiver_screen,'trade_packages_per_target':a.trade_packages_per_target,'price_frontier_targets':a.price_frontier_targets,'quick_sims':a.quick_sims,'confirm_sims':a.confirm_sims,'portfolio_candidate_depth':a.portfolio_depth,'portfolio_max_moves':a.portfolio_max_moves,'portfolio_beam_width':a.portfolio_beam_width}
    ...
    return b
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--focus-user-id',required=True); ap.add_argument('--output',required=True); ap.add_argument('--team-improvement-input'); ap.add_argument('--quick-sims',type=int,default=500); ap.add_argument('--confirm-sims',type=int,default=2500); ap.add_argument('--trade-screen',type=int,default=75); ap.add_argument('--waiver-screen',type=int,default=50); ap.add_argument('--confirm-top',type=int,default=15); ap.add_argument('--trade-packages-per-target',type=int,default=12); ap.add_argument('--price-frontier-targets',type=int,default=16); ap.add_argument('--portfolio-depth',type=int,default=15); ap.add_argument('--portfolio-max-moves',type=int,default=3); ap.add_argument('--portfolio-beam-width',type=int,default=10); ap.add_argument('--portfolio-sims',type=int,default=1000); ap.add_argument('--portfolio-confirm-sims',type=int,default=5000); ap.add_argument('--portfolio-confirm-top',type=int,default=3); ap.add_argument('--trade-review-depth',type=int,default=3); ap.add_argument('--trade-review-quick-sims',type=int,default=200); ap.add_argument('--trade-review-confirm-sims',type=int,default=50000); ap.add_argument('--trade-review-search-depth',type=int,default=60); ap.add_argument('--robustness-seeds',type=int,default=0); ap.add_argument('--robustness-sims',type=int,default=500); ap.add_argument('--seed',type=int,default=20260821); a=ap.parse_args(); out=Path(a.output); raw=Path(a.team_improvement_input) if a.team_improvement_input else out.with_suffix('.team-improvement.json')
