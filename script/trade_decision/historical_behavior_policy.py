#!/usr/bin/env python3
"""Trade Decision application policy for historical same-state behavior.
...
The underlying historical-state evidence is shared intelligence. This file owns
only the Trade Decision application's interpretation of that evidence.
